...
/*
 * This class uses the JDBC to obtain connection to the database and performs CRUD operations on the
 * project tables.
 */
...
public class ProjectDao extends DaoBase {
   ...
   * and categories. If the matching project ID is not found, it throws an exception.
   */
  ...
  /*
   * This methods updates the selected project. 
  ...
  /*
   * This method deletes a project from the project table if the project ID is valid. if the project
   * id deleted, the child records (material, step, category) all are deleted as well due to the ON
   * DELETE CASCADE.
   */
